...
<body>
  ...
  <section class="package-detail">
    <h1>Dusun Bambu Lembang</h1>
    <img src="Dusun Bambu Lembang.webp" alt="Dusun Bambu Lembang">
    <p>Durasi: 2 Hari 2 Malam</p>
    <p>Harga: Mulai dari Rp1.000.000</p>
    <h2>Deskripsi</h2>
    <p>Keindahan alam yang dikemas dengan suasana tradisional ala Sunda. Kombinasi yang pas untuk menghasilkan sebuah tempat wisata di Bandung yang menyenangkan.
        Sulit untuk enggak merasa tertarik datang dan makan di pinggir danau kecil yang jadi ikon Dusun Bambu, yang bisa kamu lihat di foto-foto tempat wisata populer ini. Menginap di Dusun Bambu pun bisa, mau di villa ataupun glamping.</p>
