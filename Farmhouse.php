...
<body>
  ...
  <section class="package-detail">
    <h1>Farmhouse Lembang</h1>
    <img src="Farmhouse Lembang.webp" alt="Farmhouse Lembang">
    <p>Durasi: 2 Hari 3 Malam</p>
    <p>Harga: Mulai dari Rp2.000.000</p>
    <h2>Deskripsi</h2>
    <p>Farmhouse Lembang adalah tempat wisata di area Lembang yang menawarkan pengalaman unik: theme park bergaya Eropa! Yup, selain bangunan-bangunannya yang bergaya Belanda, kamu pun bisa mengenakan kostum tradisional ala Belanda yang lucu.
        Spot fotonya banyak, dan ada restoran juga di mana kamu bisa menikmati susu yang jadi jagoan utama tempat ini serta makanan lainnya di dalam restoran dengan interior yang unik.</p>
